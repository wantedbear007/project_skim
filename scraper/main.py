    ...
    def data_reciever(body):
      ...
      if article_in_json_format and article_in_json_format["link"]:
        ...
        parsed_article = SummarizedArticles(
          title = scraped_article_with_body.get("title") or article_in_json_format["title"] or "",
          ...
          published_date = article_in_json_format["pub_date"] or scraped_article_with_body.get("published_date", None),
        ...
        article_id = PresummarizedArticleRepository.insert(engine=engine, data=parsed_article)
